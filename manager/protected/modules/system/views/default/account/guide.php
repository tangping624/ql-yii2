...
<div class="manage-content">
    ...
    <div class="padding form form-base">
        <div class="step-wrap step-two"> 
            <p class="step-2"><span> 在微信公众平台填入配置信息</span></p>
        </div>
            ...
            <div class="copy-info">
                ...
                <div class="content-wrap">
                	...
                	<div>
                        ...
                        <div>
                            <div class="col-md-10"><label>JS域名：</label><span><?=$data['wechat_js_domain']?></span></div>
                            <div class="col-md-2">
                                <a href="javascript:;" class="btn-add copy-button" id="copy_domain">复制</a>
                            </div>
                        </div> 
        ...
        $(function(){
            seajs.use(['/frontend/js/lib/dialog','copy'],function(){
                ...
                $('#ok_btn').on('click',function(){
                    window.location.href = O.path('/system/account/index');
                });
                $('#prev_btn').on('click',function(){
                    window.location.href = O.path('/system/account/add?id='+ O.getQueryStr('id'));
                });
            })
        })
    </script>
