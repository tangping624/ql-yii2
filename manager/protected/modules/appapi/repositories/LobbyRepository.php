...
class LobbyRepository extends RepositoryBase
{
    ...
    public function getBlogList($skip, $limit)
    {
        ...
        $sql = "SELECT SQL_CALC_FOUND_ROWS a.id,a.title,a.photo,a.content,a.source,a.ll_sum,a.dz_num,a.sc_num,b.headimg_url,b.name from m_blog a left join h_member b on a.member_id=b.id  ORDER BY a.created_on desc LIMIT :skip,:limit";
        $params[':skip'] = $skip;
        $params[':limit'] = $limit;
