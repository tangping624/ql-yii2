...
<style type="text/css">   
        ...
        #datavalid_goodsinfoname_error{margin-left:107px !important;}
        ...
        #form .img-wrap .opeate > span{width: 100%;text-align: center;}
        #form .img-wrap .icon{margin:0;margin-top:5px;}
        #form .img-wrap{border:none;}
...
<div class="manage-content">
    ...
    <div class="padding title-bottom">
        <a href="<?= $this->
            context->createUrl("/lobby/lobby/index")?>" class="icon-merge icon-goback" title="返回上一层">返回上一层
        </a>
        <a href="<?= $this->
            context->createUrl("/lobby/lobby/index")?>" class="color-black">游说管理
        </a>
        /
        <span>
            <?= $isEdit ? '<b>编辑游说</b>
    ...
    <div class="page-con clearfix" >
            <div  id="form" style="padding-left:80px;width:80%;">
                ...
                <div class="text-wrap clearfix" id="goodsinfoname" style="margin:20px;" >
                    <p class="fl" style="">
                        <span class="name">游说介绍</span>
                    </p>
                    <div style="width:550px;height:200px;margin-left:30px;" id="goodsinfo" class="ueedit-box fl clearfix" sign="ext"></div>
...
<script type="text/javascript"> 
    seajs.use('/modules/js/lobby/add',function(add){
        add.init();
    });
</script>
<?php $this->
