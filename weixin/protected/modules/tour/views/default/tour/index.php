...
<!--    <link rel="stylesheet" href="/modules/css/index/index.css" />-->
    <style>
        ...
        .prolist1 li .info .agent{margin-top: 0.5rem}
        ...
        <li class="clearfix">
            <a href="javascript:;" data-id="<%=data[i].id%>">
                ...
                <div class="info">
                    ...
                    <% if(data[i].typename){%>
                        <p style="margin-top: 0.3rem;"><i class="bg-green"><%=data[i].typename%></i></p>
                    <% }%>
...
beginBlock('js') ?>
    ...
    <script type="text/javascript">
        seajs.use('/modules/js/tour/index',function(index){
            index.init();
        })
    </script>
