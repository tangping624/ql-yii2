...
$yiiConfigs = [
    'components' => [
        ...
        'db' => [
            ...
            'dsn' => 'mysql:host=ykqadatabasein.mysql.rds.aliyuncs.com;dbname=mycommunity_config_beta_auto',
            'username' => 'yunshequ',
        ...
        'db_game' => [
            'class' => 'yii\db\Connection',
            'dsn' => 'mysql:host=ykqadatabasein.mysql.rds.aliyuncs.com;dbname=game_beta_auto',
            'username' => 'yunshequ',
            'password' => 'yunshequ123',
            'charset' => 'utf8',
            'enableSchemaCache' => true,
