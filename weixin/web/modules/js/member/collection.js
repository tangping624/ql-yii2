define(function(require, exports, module){
    ...
    module.exports={
        ...
        loadMore : function(type){
            var me=this;
            urlKey = "/me/member/ajax-my-collection";
            $('#loading').html('正在加载...');
            ...
            activityScroll = new $.Scroll(function(start,reqLen,callback){
                $.ajaxEx({
                    'type' : 'get',
                    'url' : $.path("/me/member/ajax-my-collection"),
                    ...
                    'success' : function(data) {
                        ...
                        if(list.length>0){
                            ...
                            if(data.page==1){
                                $('#menu').html('<p class="noData" style="text-align:center;padding-top:20px;font-size: 0.68rem">暂无收藏!</p>');
                                $('#LoadMore').hide();
                            }
                            $('#LoadMore').html('没有更多收藏了！');
                        }
